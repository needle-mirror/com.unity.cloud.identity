...
This section describes errors or problems you can encounter when you use the Identity package.
...
This sample isn't created to run with the [Input System](https://docs.unity3d.com/Packages/com.unity.inputsystem@latest) package. If you are using this package in your Project, your mouse selections may not be detected.
